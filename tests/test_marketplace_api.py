...
class TestBulkDownload:
    ...
    def test_bulk_download_not_found(self, client, auth_headers):
        ...
        response = client.get(
            "/api/v1/bulk-download/nonexistent_job_id",
            headers=auth_headers
        )
