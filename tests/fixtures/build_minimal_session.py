...
def build_minimal_session(output_dir: str):
    ...
    subprocess.run([
        ...
        "-c:v", "libx264", "-pix_fmt", "yuv420p", "-y", str(recording_path)
    ...
    if HAS_OPENPYXL:
        ...
        # Headers
        headers = [
            "game_name", "game_version", "session_id", "player_id",
            "start_time", "end_time", "duration", "platform",
            "resolution", "fps", "audio", "video", "input", "notes",
            "X1", "X2", "X3", "X4", "X5"
        ]
        ...
        # Data row
        values = [
            "TestGame", "1.0.0", "ci-test-session-001", "test-player-001",
            "2024-01-01T00:00:00.000Z", "2024-01-01T00:00:01.000Z", "1.0", "Windows",
            "640x480", "30", "true", "true", "true", "CI test session",
            "", "", "", "", ""
        ]
