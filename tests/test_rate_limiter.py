...
class TestRateLimiter:
    ...
    def setup_method(self):
        ...
        self.config_file_patch = patch('bin.recorder_rate_limiter.CONFIG_FILE', self.config_dir / "limits.json")
        self.counter_file_patch = patch('bin.recorder_rate_limiter.DAILY_COUNTER_FILE', self.config_dir / "daily_counter.json")
...
def test_integration():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Patch the module
        with patch('bin.recorder_rate_limiter.SESSION_DIR', session_dir), \
             patch('bin.recorder_rate_limiter.CONFIG_FILE', config_dir / "limits.json"), \
             patch('bin.recorder_rate_limiter.DAILY_COUNTER_FILE', config_dir / "daily_counter.json"), \
