...
def main():
    parser = argparse.ArgumentParser(description="Verify an Ed25519-signed batch manifest")
    parser.add_argument("signed_manifest", help="Path to signed manifest JSON")
    parser.add_argument(
        "--expect-pubkey",
        default=None,
