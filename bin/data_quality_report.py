...
def main():
    parser = argparse.ArgumentParser(description="Analyze buyer directory for data quality metrics")
    parser.add_argument(
        "--buyer-dir", required=True, help="Path to buyer directory containing action_camera.json"
    )
