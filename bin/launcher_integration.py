...
def main():
    parser = argparse.ArgumentParser(description="OysterPlay Launcher Integration")
    ...
    parser.add_argument("--show-banner", action="store_true", help="Display the full banner")
