...
class I18NStringLoader:
    ...
    def _get_fallback_strings(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            "en_US": {
                ...
                "tray.privacy_dashboard": "Privacy Dashboard",
                "tray.about": "About",
                "tray.quit": "Quit",
                ...
                "splash.initializing": "Initializing application",
                "splash.loading_modules": "Loading modules",
                "splash.starting_services": "Starting services",
                "splash.ready": "Ready",
                "privacy.title": "Privacy Dashboard",
                "privacy.data_collection": "Data Collection",
                "privacy.data_collection.description": "Control what data is collected",
                ...
                "privacy.diagnostics.description": "Share diagnostic information to help fix issues",
                "privacy.save": "Save Settings",
                "privacy.reset": "Reset to Defaults",
                "privacy.enabled": "Enabled",
                "privacy.disabled": "Disabled",
                "error.general": "An error occurred",
                "error.network": "Network error",
                "error.network.description": "Could not connect to the server",
                "error.permission": "Permission denied",
                "error.permission.description": "You do not have permission to perform this action",
                "error.config": "Configuration error",
                "error.config.description": "Invalid configuration file",
                "error.file_not_found": "File not found",
                "error.file_not_found.description": "The specified file does not exist",
                "error.invalid_input": "Invalid input",
                "error.invalid_input.description": "The provided input is not valid",
                "error.timeout": "Operation timed out",
                "error.timeout.description": "The operation took too long to complete",
                "error.retry": "Retry",
                "error.cancel": "Cancel",
                "error.ok": "OK",
            },
            "zh_CN": {
                ...
                "tray.settings": "设置",
                "tray.privacy_dashboard": "隐私仪表板",
                "tray.about": "关于",
                "tray.quit": "退出",
                "tray.connection_status": "连接状态",
                "tray.connected": "已连接",
                "tray.disconnected": "已断开",
                "tray.connecting": "连接中...",
                "splash.loading": "加载中...",
                "splash.initializing": "正在初始化应用程序",
                "splash.loading_modules": "正在加载模块",
                "splash.starting_services": "正在启动服务",
                "splash.ready": "准备就绪",
                "privacy.title": "隐私仪表板",
                "privacy.data_collection": "数据收集",
                "privacy.data_collection.description": "控制收集哪些数据",
                "privacy.analytics": "分析",
                "privacy.analytics.description": "通过分享使用统计帮助改进应用程序",
                "privacy.diagnostics": "诊断",
                "privacy.diagnostics.description": "分享诊断信息以帮助修复问题",
                "privacy.save": "保存设置",
                "privacy.reset": "重置为默认值",
                "privacy.enabled": "已启用",
                "privacy.disabled": "已禁用",
                "error.general": "发生错误",
                "error.network": "网络错误",
                "error.network.description": "无法连接到服务器",
                "error.permission": "权限被拒绝",
                "error.permission.description": "您没有执行此操作的权限",
                "error.config": "配置错误",
                "error.config.description": "配置文件无效",
                "error.file_not_found": "文件未找到",
                "error.file_not_found.description": "指定的文件不存在",
                "error.invalid_input": "输入无效",
                "error.invalid_input.description": "提供的输入无效",
                "error.timeout": "操作超时",
                "error.timeout.description": "操作耗时过长",
                "error.retry": "重试",
                "error.cancel": "取消",
                "error.ok": "确定",
            },
            "zh_TW": {
                ...
                "tray.hide_window": "隱藏視窗",
                "tray.settings": "設定",
                "tray.privacy_dashboard": "隱私儀表板",
                "tray.about": "關於",
                "tray.quit": "退出",
                "tray.connection_status": "連線狀態",
                "tray.connected": "已連線",
                "tray.disconnected": "已斷線",
                "tray.connecting": "連線中...",
                "splash.loading": "載入中...",
                "splash.initializing": "正在初始化應用程式",
                "splash.loading_modules": "正在載入模組",
                "splash.starting_services": "正在啟動服務",
                "splash.ready": "準備就緒",
                "privacy.title": "隱私儀表板",
                "privacy.data_collection": "資料收集",
                "privacy.data_collection.description": "控制收集哪些資料",
                "privacy.analytics": "分析",
                "privacy.analytics.description": "透過分享使用統計幫助改進應用程式",
                "privacy.diagnostics": "診斷",
                "privacy.diagnostics.description": "分享診斷資訊以幫助修復問題",
                "privacy.save": "儲存設定",
                "privacy.reset": "重設為預設值",
                "privacy.enabled": "已啟用",
                "privacy.disabled": "已停用",
                "error.general": "發生錯誤",
                "error.network": "網路錯誤",
                "error.network.description": "無法連線到伺服器",
                "error.permission": "權限被拒絕",
                "error.permission.description": "您沒有執行此操作的權限",
                "error.config": "設定錯誤",
                "error.config.description": "設定檔案無效",
                "error.file_not_found": "檔案未找到",
                "error.file_not_found.description": "指定的檔案不存在",
                "error.invalid_input": "輸入無效",
                "error.invalid_input.description": "提供的輸入無效",
                "error.timeout": "操作逾時",
                "error.timeout.description": "操作耗時過長",
                "error.retry": "重試",
                "error.cancel": "取消",
                "error.ok": "確定",
            },
    ...
    def translate(self, message_id: str, **kwargs) -> str:
        ...
        if (
            self.current_locale in self.fallback_strings
            and message_id in self.fallback_strings[self.current_locale]
        ):
    ...
    def _export_json(self, output_dir: Path, locale: str) -> None:
        ...
        with open(output_file, "w", encoding="utf-8") as f:
            json.dump(
                {"locale": locale, "translations": translations}, f, ensure_ascii=False, indent=2
            )
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    translate_parser.add_argument(
        "--format-args", "-f", type=json.loads, default="{}", help="Format args as JSON"
    )
    ...
    export_parser.add_argument(
        "--format", "-f", choices=["po", "json"], default="po", help="Output format"
    )

    # Validate command
    validate_parser = subparsers.add_parser("validate", help="Validate translation files")
    validate_parser.add_argument(
        "--locale-dir", "-d", required=True, help="Directory containing locale files"
    )
