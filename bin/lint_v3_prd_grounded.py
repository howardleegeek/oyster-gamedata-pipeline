...
Cluster A: Full PRD page-by-page lint tool. 32 acceptance criteria.
...
class LintReport:
    ...
    total_checks: int = 32  # rc17.1: bumped from 27 to 32 (Stream BC adds 28-32)
    passed_count: int = 0
    failed_count: int = 0
...
def run_all_checks(data_dir: Path) -> LintReport:
    """Run all 32 lint checks on the data directory."""
    rpt = LintReport(data_dir=data_dir, total_checks=32)
