...
def main(argv: list[str]) -> int:
    ...
    parser = argparse.ArgumentParser(description="Test int64 max values for frame_id overflow.")
    parser.add_argument("--run-all", action="store_true", help="Run all boundary tests")
