...
def watch_loop(path: str, min_gb: float, parent_pid: int, check_interval: float = 5.0) -> int:
    """
...
Examples:
  ...
  bin/disk_full_guard.py --path /tmp --min-gb 5 --parent-pid $$ &
    ...
    parser.add_argument("--path", required=True, help="Path to monitor disk space for")
