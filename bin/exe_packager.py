...
binary is copied to the output path.  No external runtime deps beyond stdlib.
"""
...
def _find_artefact(dist_tmp: Path, name: str, onefile: bool) -> Path | None:
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        artefact = _find_artefact(dist_tmp, name, onefile)
        if artefact is None:
