...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument(
        "--output", "-o", required=True, help="Output directory for LeRobot dataset"
    )
    parser.add_argument(
        "--repo-id", default=None, help="HuggingFace repo-id (org/name) for optional push"
    )
    parser.add_argument(
        "--push", action="store_true", help="Push output to HuggingFace Hub after export"
    )
