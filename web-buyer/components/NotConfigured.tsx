 ...
 *
 * Mirror of web-tester/components/NotConfigured.tsx — kept in sync.
 */

interface NotConfiguredProps {
  service: "Supabase" | "Stripe Checkout" | "Storage";
  envVars: string[];
  docsUrl?: string;
}
    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      <div className="rounded-lg border border-amber-300 bg-amber-50 p-6 dark:border-amber-700 dark:bg-amber-950">
        ...
        <p className="mt-2 text-sm text-amber-800 dark:text-amber-200">
          The buyer portal renders real {service.toLowerCase()} data. Set the
