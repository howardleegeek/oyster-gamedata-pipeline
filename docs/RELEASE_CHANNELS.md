...
|---|---|---|---|
| Consumer installer | `v0.11.9` | `OysterRecorder-setup-v2.6.0.exe` + `SHA256SUMS.txt` | Latest public/internal distribution line. Appcast points here. |
...
Keep the current `v0.11.9` consumer path as the production baseline. Use
