...
|---|---|---|---|
| Consumer installer | `v0.13.0` | `OysterRecorder-Setup-v0.12.3.exe` + `SHA256SUMS.txt` | Latest public/internal distribution line. Appcast points here. |
...
Keep the current `v0.13.0` consumer path as the production baseline. Use
