...
|---|---|---|---|
| Consumer installer | `v0.15.0` | `OysterRecorder-Setup-v0.15.0.exe` + `SHA256SUMS.txt` | Latest public/internal distribution line. Appcast points here. |
...
Keep the current `v0.15.0` consumer path as the production baseline. Use
